...
4. Your app is live at `https://github.com/ATK145/task3-the-knowledge-analyst`
...
```bash
# Clone the repo
git clone https://github.com/yourname/task3-the-knowledge-analyst.git
cd task3-the-knowledge-analyst
  ...
  async fetch(request, env) {
    if (request.method === 'OPTIONS') {
      return new Response(null, {
        headers: {
          'Access-Control-Allow-Origin': 'https://atk145.github.io/task3-the-knowledge-analyst',
...
```bash
ANTHROPIC_API_KEY=sk-ant-... ALLOWED_ORIGIN=https://atk145.github.io/task3-the-knowledge-analyst node server.js
```
